...
public class PlayerController : MonoBehaviour
{
    ...
    {
        _bloodValue.fillAmount = (float)playerData.Blood / playerData.BloodMax;
        _bloodText.text = playerData.Blood.ToString() + "/" + playerData.BloodMax.ToString();

        _energyValue.fillAmount = (float)playerData.Energy / playerData.EnergyMax;
        _energyText.text = playerData.Energy.ToString() + "/" + playerData.EnergyMax.ToString();
