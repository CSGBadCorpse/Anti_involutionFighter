...
namespace ET.Client
{
    ...
    {
        [ObjectSystem]
        public class LoginPanelSourceComponentYIUIBindSystem: YIUIBindSystem<LoginPanelSourceComponent>
        {
            protected override void YIUIBind(LoginPanelSourceComponent self)
            {
                self.UIBind();
            }
        }
        
        private static void UIBind(this LoginPanelSourceComponent self)
        {
